...
public class NuoNuoBaseControllerBeanEx extends com.kingdee.eas.api.nuonuo.app.NuoNuoBaseControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.api.nuonuo.app.NuoNuoBaseControllerBeanEx");
    protected void _getToken(Context ctx, IObjectValue model)throws BOSException
    {
	     super._getToken(ctx, model);
    }
}				
