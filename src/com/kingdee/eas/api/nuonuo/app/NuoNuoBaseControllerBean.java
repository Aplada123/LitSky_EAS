...
public class NuoNuoBaseControllerBean extends AbstractNuoNuoBaseControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.api.nuonuo.app.NuoNuoBaseControllerBean");
}