...
public abstract class WlhlBillBase extends CoreBillBase implements IWlhlBillBase
{
    public WlhlBillBase()
    {
        super();
        registerInterface(IWlhlBillBase.class, this);
    }
    public WlhlBillBase(Context ctx)
    {
        super(ctx);
        registerInterface(IWlhlBillBase.class, this);
    }
    ...
    private WlhlBillBaseController getController() throws BOSException
    {
        return (WlhlBillBaseController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getWlhlBillBaseInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWlhlBillBaseInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWlhlBillBaseInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWlhlBillBaseCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWlhlBillBaseCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWlhlBillBaseCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *dynamicSave-User defined method
     *@param model model
     *@return
     */
    public IObjectPK dynamicSave(WlhlBillBaseInfo model) throws BOSException, EASBizException
    {
        try {
            return getController().dynamicSave(getContext(), model);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().dynamicSaveBatch(getContext(), cols);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().dynamicExe(getContext(), exeType, obj);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
