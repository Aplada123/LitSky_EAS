...
public abstract class AbstractWlhlBillBaseControllerBean extends CoreBillBaseControllerBean implements WlhlBillBaseController
{
    ...
    public IObjectPK dynamicSave(Context ctx, WlhlBillBaseInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("e0ba64c9-a9ed-4b81-9834-dc36c78a1884"), new Object[]{ctx, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    protected abstract IObjectPK _dynamicSave(Context ctx, IObjectValue model) throws BOSException, EASBizException;

    public IObjectPK[] dynamicSaveBatch(Context ctx, IObjectCollection cols) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("496a72d0-eaeb-4fa2-aa97-8a43b2a8e2c2"), new Object[]{ctx, cols});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    protected abstract IObjectPK[] _dynamicSaveBatch(Context ctx, IObjectCollection cols) throws BOSException, EASBizException;

    public void dynamicDelete(Context ctx, IObjectPK[] pks) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("03e48f7d-e549-4786-92a5-4a08d16b9512"), new Object[]{ctx, pks});
            invokeServiceBefore(svcCtx);
              if(!svcCtx.invokeBreak()) {
    ...
    protected abstract void _dynamicDelete(Context ctx, IObjectPK[] pks) throws BOSException, EASBizException;

    public Object dynamicExe(Context ctx, String exeType, Object obj) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("3a6e2358-9ee0-4b68-a94a-e0ae629a12d3"), new Object[]{ctx, exeType, obj});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    protected abstract Object _dynamicExe(Context ctx, String exeType, Object obj) throws BOSException, EASBizException;
