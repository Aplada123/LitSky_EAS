 ...
 * output class name
 */
public abstract class AbstractWlhlCoreBillListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWlhlCoreBillListUI.class);
    /**
     * output class constructor
     */
    public AbstractWlhlCoreBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWlhlCoreBillListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wlhllicensemanager.app.WlhlCoreBillListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wlhllicensemanager.client", "WlhlCoreBillListUI");
    }
