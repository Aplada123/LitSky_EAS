 ...
 * output class name
 */
public abstract class AbstractWlhlCoreBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWlhlCoreBillEditUI.class);
    protected com.kingdee.eas.framework.CoreBillBaseInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractWlhlCoreBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWlhlCoreBillEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wlhllicensemanager.app.WlhlCoreBillEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wlhllicensemanager.client", "WlhlCoreBillEditUI");
    }
