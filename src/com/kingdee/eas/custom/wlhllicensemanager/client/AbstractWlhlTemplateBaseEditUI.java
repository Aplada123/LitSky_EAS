 ...
 * output class name
 */
public abstract class AbstractWlhlTemplateBaseEditUI extends com.kingdee.eas.custom.wlhllicensemanager.client.WlhlBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWlhlTemplateBaseEditUI.class);
    protected com.kingdee.eas.custom.wlhllicensemanager.WlhlTemplateBaseInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractWlhlTemplateBaseEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWlhlTemplateBaseEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contbaseStatus.setBounds(new Rectangle(15, 93, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wlhllicensemanager.app.WlhlTemplateBaseEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wlhllicensemanager.WlhlTemplateBaseInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wlhllicensemanager.client", "WlhlTemplateBaseEditUI");
    }
    ...
    {
        return com.kingdee.eas.custom.wlhllicensemanager.client.WlhlTemplateBaseEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.wlhllicensemanager.WlhlTemplateBaseFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.wlhllicensemanager.WlhlTemplateBaseInfo objectValue = new com.kingdee.eas.custom.wlhllicensemanager.WlhlTemplateBaseInfo();
