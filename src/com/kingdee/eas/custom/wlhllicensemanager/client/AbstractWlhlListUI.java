 ...
 * output class name
 */
public abstract class AbstractWlhlListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWlhlListUI.class);
    /**
     * output class constructor
     */
    public AbstractWlhlListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWlhlListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wlhllicensemanager.app.WlhlListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wlhllicensemanager.client", "WlhlListUI");
    }
