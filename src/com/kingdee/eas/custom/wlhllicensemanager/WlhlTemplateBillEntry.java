...
public class WlhlTemplateBillEntry extends CoreBillEntryBase implements IWlhlTemplateBillEntry
{
    public WlhlTemplateBillEntry()
    {
        super();
        registerInterface(IWlhlTemplateBillEntry.class, this);
    }
    public WlhlTemplateBillEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IWlhlTemplateBillEntry.class, this);
    }
    ...
    private WlhlTemplateBillEntryController getController() throws BOSException
    {
        return (WlhlTemplateBillEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getWlhlTemplateBillEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWlhlTemplateBillEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWlhlTemplateBillEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWlhlTemplateBillEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWlhlTemplateBillEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWlhlTemplateBillEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
